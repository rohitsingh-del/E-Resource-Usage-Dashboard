...
import { Loader2, Calendar, Newspaper, IndianRupee, BarChart3, Calculator } from 'lucide-react';
import { Card } from './ui/Card';
import { NewspaperOverview } from './NewspaperOverview';
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex bg-slate-100 dark:bg-slate-900 rounded-lg p-1">
                        <button
                            ...
                            className={`flex items-center gap-2 px-3 py-1.5 text-sm font-medium rounded-md transition-all ${activeTab === 'overview'
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-3 py-1.5 text-sm font-medium rounded-md transition-all ${activeTab === 'monthly'
                                    ? 'bg-white dark:bg-slate-800 text-accent shadow-sm'
                                    : 'text-slate-500 hover:text-slate-700 dark:hover:text-slate-300'
                                }`}
                        >
